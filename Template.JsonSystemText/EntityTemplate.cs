...
{
    public class T_MemberTypeImplName_ : EntityBase, T_MemberTypeIntfName_, IEquatable<T_MemberTypeImplName_>
    {
        ...
        public static T_MemberTypeImplName_ CreateFrom(T_MemberTypeIntfName_ source) => throw new NotImplementedException();
        public T_MemberTypeImplName_() { }
        public T_MemberTypeImplName_(T_MemberTypeIntfName_ source) { }
...
namespace T_IntfNameSpace_
{
    public interface T_EntityIntfName_ : T_BaseIntfNameSpace_.T_BaseIntfName_
    {
        ...
        T_MemberTypeNameSpace_.T_MemberTypeIntfName_? T_NullableEntityMemberName_ { get; set; }
        T_MemberTypeNameSpace_.T_MemberTypeIntfName_ T_RequiredEntityMemberName_ { get; set; }
...
namespace T_ImplNameSpace_
{
    ...
    public partial class T_EntityImplName_ : T_BaseImplNameSpace_.T_BaseImplName_, T_IntfNameSpace_.T_EntityIntfName_, IEquatable<T_EntityImplName_>
    {
        ...
        public T_EntityImplName_(T_IntfNameSpace_.T_EntityIntfName_ source) : base(source)
        {
            ...
            //##case MemberKind.Entity:
            //##if (member.IsNullable) {
            _T_NullableEntityMemberName_ = source.T_NullableEntityMemberName_ is null ? null : T_MemberTypeNameSpace_.JsonSystemText.T_MemberTypeImplName_.CreateFrom(source.T_NullableEntityMemberName_);
            //##} else {
            _T_RequiredEntityMemberName_ = T_MemberTypeNameSpace_.JsonSystemText.T_MemberTypeImplName_.CreateFrom(source.T_RequiredEntityMemberName_);
            //##}
            //##break;
            //##case MemberKind.Binary:
            //##if (member.IsNullable) {
        ...
        T_MemberTypeNameSpace_.T_MemberTypeIntfName_? T_IntfNameSpace_.T_EntityIntfName_.T_NullableEntityMemberName_
        {
            get => _T_NullableEntityMemberName_;
        ...
        T_MemberTypeNameSpace_.T_MemberTypeIntfName_ T_IntfNameSpace_.T_EntityIntfName_.T_RequiredEntityMemberName_
        {
            get => _T_RequiredEntityMemberName_;
