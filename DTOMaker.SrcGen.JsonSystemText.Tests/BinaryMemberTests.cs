...
namespace DTOMaker.SrcGen.JsonSystemText.Tests
{
    public class BinaryMemberTests
    {
        ...
        public void BinaryMember00_GeneratedSourcesLengthShouldBe1()
        {
            ...
            generatorResult.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.MyDTO.JsonSystemText.g.cs");
            generatorResult.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.Other.JsonSystemText.g.cs");
        }
