...
namespace MyOrg.Models.JsonSystemText
{
    public partial class MyDTO : DTOMaker.Runtime.JsonSystemText.EntityBase, IMyDTO, IEquatable<MyDTO>
    {
        ...
        {
            _Custom1 = source.Custom1;
            _Custom2 = source.Custom2;
            _Custom3 = source.Custom3;
        }
        public MyDTO(MyDTO source) : base(source)
        {
            _Custom1 = source._Custom1;
            _Custom2 = source._Custom2;
            _Custom3 = source._Custom3;
        }

        [JsonIgnore]
        private PairOfInt64 _Custom1 = default;
        public PairOfInt64 Custom1
        {
            get => _Custom1;
            set => _Custom1 = IfNotFrozen(value);
        }

        [JsonIgnore]
        private PairOfInt32 _Custom2 = default;
        public PairOfInt32 Custom2
        {
            get => _Custom2;
            set => _Custom2 = IfNotFrozen(value);
        }

        [JsonIgnore]
        private PairOfInt16 _Custom3 = default;
        public PairOfInt16 Custom3
        {
            get => _Custom3;
            set => _Custom3 = IfNotFrozen(value);
        }
        ...
        public bool Equals(MyDTO? other)
        {
            ...
            if (_Custom1 != other.Custom1) return false;
            if (_Custom2 != other.Custom2) return false;
            if (_Custom3 != other.Custom3) return false;
            return true;
        }
