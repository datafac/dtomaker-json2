...
namespace MyOrg.Models.JsonSystemText
{
    ...
    public partial class Quadrilateral : MyOrg.Models.JsonSystemText.Polygon, IQuadrilateral, IEquatable<Quadrilateral>
    {
        ...
        public static new Quadrilateral Empty => _empty;
        ...
        protected override IEntityBase OnPartCopy() => new Quadrilateral(this);

        public Quadrilateral() { }
        public Quadrilateral(IQuadrilateral source) : base(source)
        {
        }
        public Quadrilateral(Quadrilateral source) : base(source)
        {
        }
