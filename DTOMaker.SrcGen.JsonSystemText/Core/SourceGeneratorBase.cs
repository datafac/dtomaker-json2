...
namespace DTOMaker.SrcGen.Core
{
    public abstract class SourceGeneratorBase : IIncrementalGenerator
    {
        ...
        protected abstract void OnEndInitialize(IncrementalGeneratorInitializationContext context);
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(markedInterfaces, (spc, intf) =>
            {
                ...
                var sb = new StringBuilder();
                sb.AppendLine("// <auto-generated/>");
                sb.AppendLine($"// Fullname : {intf.Fullname}");
                sb.AppendLine($"// Namespace: {intf.ModelNamespace}");
                sb.AppendLine($"// Name     : {intf.EntityName}");
                sb.AppendLine($"// Id       : {intf.EntityId}");
                sb.AppendLine($"// Members  : {intf.Values.Count}");
                string hintName = $"{intf.ModelNamespace}.JsonSystemText.{intf.EntityName}.g.cs";
