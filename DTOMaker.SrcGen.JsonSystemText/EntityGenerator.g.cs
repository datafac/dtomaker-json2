...
public sealed class EntityGenerator : EntityGeneratorBase
{
    ...
    protected override void OnGenerate(OutputEntity entity)
    {
        ...
        Emit("// <auto-generated>");
        Emit("// This file was generated by DTOMaker.JsonSystemText.");
        Emit("// NuGet: https://www.nuget.org/packages/DTOMaker.JsonSystemText");
        ...
        if (false)
        {
            ...
            Emit("{");
            Emit("    public class T_MemberTypeImplName_ : EntityBase, T_MemberTypeIntfName_, IEquatable<T_MemberTypeImplName_>");
            Emit("    {");
            ...
            Emit("");
            Emit("        public static T_MemberTypeImplName_ CreateFrom(T_MemberTypeIntfName_ source) => throw new NotImplementedException();");
            Emit("        public T_MemberTypeImplName_() { }");
            Emit("        public T_MemberTypeImplName_(T_MemberTypeIntfName_ source) { }");
            ...
            Emit("        T_MemberTypeNameSpace_.T_MemberTypeIntfName_? T_NullableEntityMemberName_ { get; set; }");
            Emit("        T_MemberTypeNameSpace_.T_MemberTypeIntfName_ T_RequiredEntityMemberName_ { get; set; }");
            ...
            foreach (var member in entity.Members)
            {
                ...
                switch (member.Kind)
                {
                    ...
                    case MemberKind.Entity:
                        if (member.IsNullable)
                        {
                            Emit("            _T_NullableEntityMemberName_ = source.T_NullableEntityMemberName_ is null ? null : T_MemberTypeNameSpace_.JsonSystemText.T_MemberTypeImplName_.CreateFrom(source.T_NullableEntityMemberName_);");
                        }
                        else
                        {
                            Emit("            _T_RequiredEntityMemberName_ = T_MemberTypeNameSpace_.JsonSystemText.T_MemberTypeImplName_.CreateFrom(source.T_RequiredEntityMemberName_);");
                        }
                        break;
                    case MemberKind.Binary:
                        if (member.IsNullable)
            ...
            foreach (var member in entity.Members)
            {
                ...
                switch (member.Kind)
                {
                    ...
                    case MemberKind.Vector:
                        ...
                        Emit("        }");
                        Emit("        ReadOnlyMemory<T_MemberType_> T_IntfNameSpace_.T_EntityIntfName_.T_VectorMemberName_");
                        Emit("        {");
                    ...
                    case MemberKind.Entity:
                        if (member.IsNullable)
                        {
                            ...
                            Emit("        }");
                            Emit("        T_MemberTypeNameSpace_.T_MemberTypeIntfName_? T_IntfNameSpace_.T_EntityIntfName_.T_NullableEntityMemberName_");
                            Emit("        {");
                            Emit("            get => _T_NullableEntityMemberName_;");
                        ...
                        else
                        {
                            ...
                            Emit("        }");
                            Emit("        T_MemberTypeNameSpace_.T_MemberTypeIntfName_ T_IntfNameSpace_.T_EntityIntfName_.T_RequiredEntityMemberName_");
                            Emit("        {");
                            Emit("            get => _T_RequiredEntityMemberName_;");
